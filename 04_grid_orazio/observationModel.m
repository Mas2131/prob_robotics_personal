function observation_probability = observationModel(map_, row_, col_, observations_)
  ...
  #evaluate cell occupancy - it tells if the cell is occupied
  cell_up_occupied    = 0;
  ...
  if (cell_up_occupied == observations_(1))
	   observation_probability *= 0.8; #true positive - since here we have noise and in the slides we defined that the accuracy of the bumpers is 0.8
  % else
  ...
  % else
	  % observation_probability *= 0.8; #false positive
  endif
